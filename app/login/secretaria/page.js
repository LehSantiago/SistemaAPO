// src/app/login/secretaria/page.js
'use client';
  ...
  const handleSubmit = async (e) => {
   ...
   try {
      const response = await fetch('/api/login', {  // ✅ Sem localhost:5000
        ...
        body: JSON.stringify({
          ...formData,
          tipo: 'secretaria'  // ✅ Corrigido o tipo
        })
      });
  ...
  return (
    <div className={styles.container}>
      <div className={styles.loginBox}>
        <div className={styles.header} style={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)' }}>
          <div className={styles.icon}>📊</div>
          <h1 className={styles.title}>Login da Secretaria</h1>
        ...
        <div className={styles.testInfo}>
          ...
          <p className={styles.testCredential}>Email: secretaria@teste.com</p>
